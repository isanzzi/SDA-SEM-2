...
#include <stdio.h>
/* Prototype */
void f1(void); //parameter void berguna untuk kejelasan bahwa fungsi tidak menerima parameter.
void f2(void); //parameter void berguna untuk kejelasan bahwa fungsi tidak menerima parameter.
void f3(void); //parameter void berguna untuk kejelasan bahwa fungsi tidak menerima parameter.
void f4(void); //parameter void berguna untuk kejelasan bahwa fungsi tidak menerima parameter.
/* kamus Global */
#define true 1
#define false 0
int quit = false;
